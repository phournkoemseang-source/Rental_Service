  ...
  <section class="shop-dashboard">
    ...
    <div v-if="!hasShop" class="onboarding-card animate-fade-in-up">
      <div class="onboarding-main">
        ...
        <p>Create your shop profile, add vehicles, and start receiving bookings in just a few minutes.</p>
      ...
      <div class="stepper-track">
        <div class="onboarding-steps">
          <div class="step">
            ...
            <span class="step-label">Create shop profile</span>
            <span class="step-line" aria-hidden="true"></span>
          </div>
          <div class="step">
            <span class="step-circle">2</span>
            <span class="step-label">Add vehicles</span>
            <span class="step-line" aria-hidden="true"></span>
          </div>
          <div class="step">
            <span class="step-circle">3</span>
            <span class="step-label">Receive bookings</span>
          </div>
        </div>
      </div>
    </div>
